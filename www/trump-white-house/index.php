...
<html class="no-js" lang="en">
    <head>
                ...
                <!-- Description-->
                <meta name="description" content="Vote on which members of Donald Trump's administration should stay and which should go" />
                <meta property="og:description" content="Vote on which members of Donald Trump's administration should stay and which should go" />
                <meta name="twitter:description" content="Vote on which members of Donald Trump's administration should stay and which should go" />
        ...
        <script type="application/ld+json">
            {
                ...
                "keywords": ["interactive","interactive poll","donald trump","ivanka trump","betsy devos","stephen miller","mike pence"]
            }
        </script>
...
<!--begin main content -->
    ...
    <script>
    var app_config = { 
        description: "Vote on which members of Donald Trump's administration should stay and which should go",
        team: 'Trump',
        year: '2018',
        gender: 'him',
    ...
    <main>
        <div id="top" class="row"> 
            ...
            <h1 class="columns">2018 Keep&nbsp;'em or Dump&nbsp;'em: Trump's White House</h1>
...
-->
 Of those remaining in Trump’s White House, who do you think will last the term – and who is the next to get dumped by Trump? <strong>VOTE NOW.</strong>
    ...
    <footer id="nydn-footer">
        ...
        <script src="../js/app-keepem.js<?php echo $append; ?>"></script>
        <script>
        keepem.init();
                $(document).foundation();
        </script>
