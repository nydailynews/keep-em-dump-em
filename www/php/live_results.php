...
{
	$table = 'kd_' . $team;
	$query = 'select name, section, keep, dump from ' . $table . ' WHERE year = ' . $year;
	...
	echo '<thead><tr><th>PLAYER</th><th>Role</th><th>KEEP</th><th>DUMP</th><th>Dump %</th><th>TOTAL</th></tr></thead><tbody>' . "\n";
